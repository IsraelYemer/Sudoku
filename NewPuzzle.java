...
/**
 * This generates textField cells to hold the value of the new puzzle
 * @see GameTracker
 */
public class NewPuzzle extends JPanel {

    private static final int GRID_SIZE = 9;

    /**
     * Constructor for class NewPuzzle
     */
    public NewPuzzle(){
        ...
        for (int row = 0; row < GRID_SIZE; row++) {
            for (int column = 0; column < GRID_SIZE; column++) {
                ...
                JTextField textField = new JTextField(String.valueOf(GameTracker.newPuzzle[row][column]));
